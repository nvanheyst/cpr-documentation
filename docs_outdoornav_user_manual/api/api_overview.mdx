...
-   [Endpoints](./api_endpoints/autonomy/mission): Provides the endpints for all, autonomy, docking,
    localization ,logger, mission manager endpoints that can be used to control/monitor the
    OutdoorNav system.
-   [Examples](./api_examples/looped_mission): API examples will be avialable as of version 2.3.0.
