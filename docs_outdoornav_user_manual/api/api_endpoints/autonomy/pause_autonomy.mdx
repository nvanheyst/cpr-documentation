...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<std_srvs::srv::SetBool>::SharedPtr client =
    node->create_client<std_srvs::srv::SetBool>("/" + namespace_ + "/" + std::string("autonomy/pause"));
    ...
    rclcpp::FutureReturnCode::SUCCESS)
  {
    ...
    {
      RCLCPP_INFO(rclcpp::get_logger("pause_autonomy_client"), "Autonomy failed to pause!");
    }
  } else {
