...
Documents/General/Releases/\<version\> and download one of the following files:
...
4. Transfer all files to the robots /opt/onav/ folder
    ...
    **Linux**:
    ...
    ```code
    scp cpr-onav-app.zip cpr-onav-ui.tar cpr-onav-base.tar cpr-onav-autonomy.tar robot@192.168.131.1:/home/robot
    ```
