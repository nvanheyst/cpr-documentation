...
class DeleteDock(Node):
    ...
    def delete_dock_srv_response_cb(self, future):
        try:
            response = future.result()
            if response.success:
                self.get_logger().info(f'[{LOGGING_NAME}] Deleted dock successfully!')
            else:
...
class ExportDock(Node):
    ...
    def export_dock_srv_response_cb(self, future):
        try:
            response = future.result()
            if response.success:
                self.get_logger().info(f'[{LOGGING_NAME}] Exported dock successfully!')
            else:
...
class ExportDock(Node):
    ...
    def export_dock_srv_response_cb(self, future):
        try:
            response = future.result()
            if response.success:
                self.get_logger().info(f'[{LOGGING_NAME}] Exported dock data successfully!')
            else:
...
class GetDockDatabase(Node):
    ...
    def get_dock_database_srv_response_cb(self, future):
        try:
            response = future.result()
            if response.success:
                self.get_logger().info(f'[{LOGGING_NAME}] Retrieved dock database successfully!')
            else:
...
class ImportDock(Node):
    ...
    def import_dock_srv_response_cb(self, future):
        try:
            response = future.result()
            if response.success:
                self.get_logger().info(f'[{LOGGING_NAME}] Imported dock successfully!')
            else:
...
class UpdateDock(Node):
    ...
    def update_dock_srv_response_cb(self, future):
        try:
            response = future.result()
            if response.success:
                self.get_logger().info(f'[{LOGGING_NAME}] Updated dock successfully!')
            else:
...
class GetDockPoses(Node):
    ...
    def get_dock_poses_srv_response_cb(self, future):
        try:
            response = future.result()
            if response.success:
                self.get_logger().info(f'[{LOGGING_NAME}] Retrieved dock poses successfully!')
            else:
...
class ConvertLatLonToCartesian(Node):
    ...
    def convert_latlon_client_srv_response_cb(self, future):
        try:
            response = future.result()
            if response.success:
                self.get_logger().info(f'[{LOGGING_NAME}] Converted lat/lon to xy successfully!')
            else:
...
int main(int argc, char **argv)
{
    ...
    rclcpp::FutureReturnCode::SUCCESS)
  {
    if (result.get()->success)
    {
      RCLCPP_INFO(rclcpp::get_logger("convert_latlon_client"), "Converted lat/lon to xy successfully!");
    }
    else
    {
...
class ConvertCartesianToLatLon(Node):
    ...
    def convert_xy_client_srv_response_cb(self, future):
        try:
            response = future.result()
            if response.success:
                self.get_logger().info(f'[{LOGGING_NAME}] Converted xy to lat/lon successfully!')
            else:
...
int main(int argc, char **argv)
{
    ...
    rclcpp::FutureReturnCode::SUCCESS)
  {
    if (result.get()->success)
    {
      RCLCPP_INFO(rclcpp::get_logger("convert_xy_client"), "Converted xy to lat/lon successfully!");
    }
    else
    {
