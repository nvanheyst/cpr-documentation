...
public:
  ...
  {
    auto mode_cb =
      [this](clearpath_control_msgs::msg::ControlMode::UniquePtr msg) -> void {
        last_mode_msg_ = msg;
      };

    mode_sub_ = this->create_subscription<clearpath_control_msgs::msg::ControlMode>("control_selection/current_mode", 10, mode_cb);
  }

private:
  rclcpp::Subscription<clearpath_control_msgs::msg::ControlMode>::SharedPtr mode_sub_;
  clearpath_control_msgs::msg::ControlMode::UniquePtr last_mode_msg_;
};
...
The lat/lon coordinate of the datum. This value is stored in persistent memory and loaded at runtime.
...
class SpeedLimit(Node):
    ...
    def __init__(self):
        ...
        self.speed_limit_sub = self.create_subscription(
            SpeedLimit, 'speed_limit', self.speed_limit_cb, 10)
...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<clearpath_control_msgs::srv::SetControlMode>::SharedPtr client =
    node->create_client<clearpath_control_msgs::srv::SetControlMode>("control_selection/set_mode");

  auto request = std::make_shared<clearpath_control_msgs::srv::SetControlMode::Request>();
  request->mode.mode = clearpath_control_msgs::msg::ControlMode::MANUAL;
...
int main(int argc, char **argv)
{
  ...
  dock_info.orientation = geometry_msgs::msg::Quaternion();
...
int main(int argc, char **argv)
{
  ...
  latlon_msg.latitude = 0.0;
  latlon_msg.longitude = 0.0;
...
int main(int argc, char **argv)
{
  ...
  latlon_msg1.latitude = 0.0;
  latlon_msg1.longitude = 0.0;

  auto latlon_msg2 = sensor_msgs::msg::NavSatFix();
  latlon_msg2.latitude = 0.0;
  latlon_msg2.longitude = 0.0;
...
int main(int argc, char **argv)
{
  ...
  pose_msg1.pose.position.x = 0.0;
  pose_msg1.pose.position.y = 0.0;

  auto pose_msg2 = geometry_msgs::msg::PoseStamped();
  pose_msg2.pose.position.x = 0.0;
  pose_msg2.pose.position.y = 0.0;
