...
if __name__ == '__main__':
    rclpy.init()
    execute_task_client = ExecuteTask()
...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<clearpath_task_msgs::srv::ExecuteTask>::SharedPtr client =
    node->create_client<clearpath_task_msgs::srv::ExecuteTask>("autonomy/task/execute_as_srv");
...
RCLCPP_COMPONENTS_REGISTER_NODE(execute_task_action_client::ExecuteTaskActionClient)
```
  </TabItem>
