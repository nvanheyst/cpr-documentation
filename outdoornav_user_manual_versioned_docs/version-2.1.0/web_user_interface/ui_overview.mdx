...
- <img
  ...
  - Float CSV: A list of comma separated float values that consist of the numerical inputs to the custom task.
  - String CSV: A list of comma separated string values that consist of the semantic inputs to the custom task.
...
If the user wants your UGV to navigate to a set of predefined locations they can create POIs for each of these stops and leverage
