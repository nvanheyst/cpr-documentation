...
| <center><img src="/img/outdoornav_images/impact_hazard.png" width="40px"/></center> | Impact Risk | Clearpath Robotics UGVs traveling through a facility can potentially impact objects and personnel. Keep clear of all docking Clearpath Robotics UGVs. |
...
-   Personnel should be aware that Clearpath Robotics UGV's LiDAR safety
