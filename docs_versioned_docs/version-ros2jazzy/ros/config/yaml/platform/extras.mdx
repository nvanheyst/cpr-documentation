...
```
  ...
  <TabItem value="D100" label="D100">

**D100 Dingo-D Controller Defaults:**
```yaml
platform:
  extras:
    ros_parameters:
...
```
  ...
  <TabItem value="D150" label="D150">

**D150 Dingo-O Controller Defaults:**
```yaml
platform:
  extras:
    ros_parameters:
