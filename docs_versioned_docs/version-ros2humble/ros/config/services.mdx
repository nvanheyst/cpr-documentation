...
[Platform](https://github.com/clearpathrobotics/clearpath_robot/blob/humble/clearpath_robot/services/clearpath-platform.service),
[Sensors](https://github.com/clearpathrobotics/clearpath_robot/blob/humble/clearpath_robot/services/clearpath-sensors.service), and
[Robot](https://github.com/clearpathrobotics/clearpath_robot/blob/humble/clearpath_robot/services/clearpath-robot.service).
