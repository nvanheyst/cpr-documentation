...
For specifics on the way Clearpath's configuration system launches the sensor driver, see the MicroStrain GQ7 [launch file](https://github.com/clearpathrobotics/clearpath_robot/blob/humble/clearpath_sensors/launch/microstrain_gq7.launch.py) and the [default parameter file](https://github.com/clearpathrobotics/clearpath_robot/blob/humble/clearpath_sensors/config/microstrain_gq7.yaml) in `clearpath_sensors`.

For a list of all possible parameters and documentation on what they do, see the [params.yml](https://github.com/LORD-MicroStrain/microstrain_inertial_driver_common/blob/humble/config/params.yml) provided by the `microstrain_inertial_driver`
