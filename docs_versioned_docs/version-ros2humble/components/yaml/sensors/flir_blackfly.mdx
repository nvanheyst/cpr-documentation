...
For specifics on the way Clearpath's configuration system launches the camera, see the Flir Blackfly [launch file](https://github.com/clearpathrobotics/clearpath_robot/blob/humble/clearpath_sensors/launch/flir_blackfly.launch.py) and the [default parameter file](https://github.com/clearpathrobotics/clearpath_robot/blob/humble/clearpath_sensors/config/flir_blackfly.yaml) in `clearpath_sensors`.
