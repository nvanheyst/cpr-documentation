...
The **protonc** library is separated into the core implementations for Signals and Bundles, as well as the Node implementations for higher level node and transport management.
