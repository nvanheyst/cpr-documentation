...
This section defines every Bundle that can be sent in this Proton network. A Bundle consists of a unique name and non-zero ID, a producer or list of producers, a consumer or list of consumers,
and a list of signals. An empty Bundle without any Signals is also allowed.
