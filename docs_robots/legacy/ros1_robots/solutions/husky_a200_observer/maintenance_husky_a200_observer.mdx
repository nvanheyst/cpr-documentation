...
All batteries self-discharge over time. To minimize the risk of battery
state-of-charge dropping to a dangerously low level while in storage, the
...
The rate of discharge should also be minimized by disconnecting the batteries
