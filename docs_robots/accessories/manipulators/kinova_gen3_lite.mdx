...
2.  There is a _Quick Connect Mounting Knob_ on the bottom of the arm.
    ...
    Then use a hex key to turn the _Mounting Knob's_ screw counterclockwise.
...
### ROS 2 Configuration
This manipulator is included in the Clearpath Robotics description and robot package that is installed on all of our robots.
This allows you to add or remove manipulator from your robot's software configuration by modifying the [robot configuration yaml](/docs/ros/config/yaml/manipulators).
...
If you cannot ping the computer or arm, try rebooting and replugging the Kinova Gen3 lite arm before reviewing your installation steps.
