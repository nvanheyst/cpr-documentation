...
|  <img src="/img/robot_images/dingo_images/icon-comms.png" width="50"/>  | **Comms indicator**: LED is solid green when communication between the MCU and computer has been established and LED is off otherwise                                                                                                                                                                                                                                                                                       |
...
documentation portal, under the [Computers](../../accessories/computers/computers.mdx),
