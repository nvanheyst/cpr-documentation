...
To attach custom hardware to Warthog, you will have to take care of mechanical mounting, electrical supply, and software integration.
...
You can design mounting brackets to interface with these holes.
...
- The chassis has a removable access cover measuring 1175 mm X 667 mm (46.25" X 26.25").
  ...
  Regardless of payload, it is imperative that both cross members remain installed (approximately evenly spaced) to provide required support to the access cover.
...
### Top Plate Power and Data Connections
