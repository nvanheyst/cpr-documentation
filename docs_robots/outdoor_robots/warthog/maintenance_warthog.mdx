...
The RED Charge Button is installed on Lithium Warthogs shipped after April 17, 2026. Lithium Warthogs shipped before this
date do not have the button; for those units, charging begins automatically once the charger is connected as described in
[To Connect the Charger](#to-connect-the-charger), and this section can be ignored.

:::

1. Locate the **RED Charge Button**, located on the rear panel alongside the SB50 charge connector.

   <center>
     <figure>
       <img
         src="/img/robot_images/warthog_images/warthog_charge_button.png"
         width="500"
       />
       <figcaption>Location of the RED Charge Button, alongside the SB50 charge connector</figcaption>
     </figure>
   </center>

2. Once the charger has been connected (see [To Connect the Charger](#to-connect-the-charger)), press and hold the
   **RED Charge Button for 5 seconds**. A series of audible clicks should be heard during this time.
3. The BMS is now fully powered on and the system will be charging.
...
- Due to the increased drive current, expect lower battery life than a wheeled Warthog.
  It is recommended to drive at reduced speeds to increase battery life.
