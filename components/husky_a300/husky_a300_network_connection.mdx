...
import ComponentPeplinkWifiApConnection from "/components/husky_a300/networking/husky_a300_peplink_wifi_ap_connection.mdx";
...
{((props.robotModel == "AMP") || (props.robotModel == "Observer")) && <ComponentPeplinkWifiApConnection />}
